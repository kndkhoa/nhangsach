...
function metro_magazine_customizer_theme_info( $wp_customize ) {
	...
	$theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Download Zip', 'metro-magazine' ) . ': </label><a href="' . esc_url( 'https://raratheme-wbtneb0y4p.netdna-ssl.com/wp-content/uploads/2017/12/metro-magazine-demo-content.zip' ) . '" target="_blank">' . __( 'here', 'metro-magazine' ) . '</a></span><br />';
